 ...
 * @return ERROR_CODE
 */
ERROR_CODE writeLogMessageToFile(const char *nameFileSaveLogMessage_string, struct connectionStatus _connectionStatus, const char *format_string, ...)
{
    if (_connectionStatus.sdCardStatus == status_et::CONNECTED)
    {
        File writeFile;
